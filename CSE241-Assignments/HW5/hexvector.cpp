...
namespace Mehmet{
	...
	HexVector::HexVector(int board_size_val) : AbstractHex(board_size_val) {
		set_board();
		print();
		finish_control();
	}

	HexVector::HexVector(int board_size_val,int game_type_val) : AbstractHex(board_size_val,game_type_val) {
		set_board();
		print();
		finish_control();
	}
    ...
    void HexVector::set_destinated_board(){
	...
	int HexVector::in_board_area(int pos=0,int row=0) const{
    ...
    int HexVector::control_empty_cell(int pos_val,int row_val) const{
	...
	int HexVector::all_board_fill() const{
	 ...
	 int HexVector::control_same_cell1(int row,int pos) const{
    ...
    int HexVector::control_same_cell2(int row,int pos) const{
		...
		int HexVector::control_empty_neighbors(int col,int row) const{
        ...
        int HexVector::user_computer(){
		 ...
		 int HexVector::get_command(int &pos,int &row){
		...
		int HexVector::readFromFile(string filename){
		...
		void HexVector::setSize(){
         ...
         void HexVector::play(char pos_val,int row_val){
		...
		int HexVector::play(){
         ...
         bool HexVector::isEnd(int row,int pos,int user_select_val) {
        ...
        AbstractHex::Cell HexVector::operator () (int row,int pos) throw(Exc1){
        ...
        bool HexVector::operator ==(HexVector& game){
        ...
        AbstractHex::Cell HexVector::last_move() throw(Exc2){
        ...
        bool HexVector::valid_moves() const{
        	int i,j;
